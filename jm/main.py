...
app.state.app_display_name = "JM Planner"
app.state.set_user_setting = set_user_setting
...
# ── Routes moved to common/routers/: achievements, push, export_import, gcal,
#    habits, engagement, timetable, today, stats, categories, ddays, links ──
